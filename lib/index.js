 ...
 * @property {string|null}              [getter=getLocale]              - Getter method in request object to get current locale. May be nested object such as 'a.b.c'
 * @property {string|null}              [setter=setLocale]              - Setter method in request object to set current locale. May be nested object such as 'a.b.c'
 * @property {string|null}              [attribute=locale]              - Key in request object which will be used to store locale name. May be nested path such as 'a.b.c'.
 * @property {boolean}                  [createAccessors=true]          - Creates getter and setter methods in request object.
 * @property {Function|string|null}     [callback=setLocale]            - Callback method with signature function(locale) to set locale. If given as function called directly. If given as string called as a method of request object. May be nested path such as 'a.b.c'.
...
var optionsSchema = {
    ...
    callback        : Joi.alternatives().try(Joi.string(), Joi.func()).allow(null).default(defaultOptions.callback),
...
Internal.prototype.processRequest = function processRequest(request, reply) {
    ...
    if (this.options.createAccessors) {
        lodash.set(request, getter, function() { return lodash.get(request, attribute); });
        lodash.set(request, setter, function(locale) { return lodash.set(request, attribute, locale); });
    }
