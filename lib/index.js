 ...
 * @returns {Array.<string>|undefined}  - Array of requested locales.
 * @private
 */
...
/**
 * Returns requested languages as an array by looking cookie.
 * @param {Object}          request     - Hapi request object
 * @param {PluginOptions}   options     - Plugin configuration options.
 * @returns {Array.<string>|undefined}  - Array of requested locales.
 * @private
...
/**
 * Returns requested languages as an array by looking header.
 * @param {Object}          request     - Hapi request object
 * @param {PluginOptions}   options     - Plugin configuration options.
 * @returns {Array.<string>|undefined}  - Array of requested locales.
 * @private
...
exports.register = function(server, options, next) {
    ...
    // Add getter to request if necessary.
    if (typeof options.getter === 'string' && options.getter !== '' && options.createAccessorsIfNotExists) {
        server.decorate('request', options.getter, function() {
            if (!this.i18n) this.i18n = {};
            return this.i18n.deneme;
        });
    ...
    // Add setter to request if necessary.
    if (typeof options.setter === 'string' && options.setter !== '' && options.createAccessorsIfNotExists) {
        server.decorate('request', options.setter, function(locale) {
            if (!this.i18n) this.i18n = {};
            this.i18n.deneme = locale;
            return locale;
        });
