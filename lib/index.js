 ...
 * @property {string}                   [createGetterOn=getLocale]      - If not exists, creates a getter method with this name on request object to get current locale. May be nested path such as 'a.b.c'.
 * @property {string}                   [createSetterOn=setLocale]      - If not exists, creates a setter method with this name on request object to set current locale. May be nested path such as 'a.b.c'.
